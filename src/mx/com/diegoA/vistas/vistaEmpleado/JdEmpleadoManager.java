 ...
 * @author Dies
 */
public class JdEmpleadoManager extends javax.swing.JDialog implements IManager {

    //<editor-fold defaultstate="collapsed" desc="Cuerpo Empleado Manager">
    //<editor-fold defaultstate="collapsed" desc="Variables">
    private ConfEmpleado baseEntity;
...
//</editor-fold>
    ...
    /**
     * Creates new form JdEmpleadoManager
     */
    public JdEmpleadoManager(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public JdEmpleadoManager() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        picImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mx/com/diegoA/img/1412742102_Users_Group.png"))); // NOI18N
            ...
            if (camCombo == true || camTxt == true || camJTable == true) {
                ...
                if (res == 0) {
                    if (this.validaDatos() == true) {
                        this.baseEntity.setStrUsuario(this.txtValor.getText().trim());
                        this.baseEntity.setStrContraseña(this.txtDescripcion.getText().trim());
                        //aqui falta la linea para obtener el combo seleccionado
                        if (this.idAccion == 0) {
                            this.baseEntity.setIdPerfil(this.cmbEstado.getSelectedIndex());
                        } else {
                            this.baseEntity.setIdPerfil(this.cmbEstado.getSelectedIndex() + 1);
                        }
    ...
    private void txtDescripcionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtDescripcionMouseClicked
        // Llama al evento de cambio
        this.DetectaCambio(this.txtDescripcion);
...
//</editor-fold>
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdEmpleadoManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdEmpleadoManager dialog = new JdEmpleadoManager(new javax.swing.JFrame(), true);
...
//</editor-fold>
    ...
    public Object showDialog(Object _obj) {
        this.baseEntity = (ConfEmpleado) _obj;
        this.idAccion = (this.baseEntity != null) ? this.baseEntity.getId() : 0;
        if (this.idAccion == 0) {
            this.baseEntity = new ConfEmpleado();
        }
        this.idEstado = this.baseEntity.getIdPerfil();//obtener el id de estado para el combo de editar
        this.setLoadInformation();
    ...
    public boolean validaDatos() {
        ...
        if (this.txtDescripcion.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "El campo de Password se encuentra vacio");
            return false;
        }
        if (this.idAccion == 0) {
            if (this.cmbEstado.getSelectedIndex() == 0) {
                JOptionPane.showMessageDialog(null, "Seleccione una opción valida de Perfil");
                return false;
            }
    ...
    public boolean setComboBoxInitial() {
        ...
        try {
            CtrlConfPerfiles estadoG = new CtrlConfPerfiles();
            ...
            Logger.getLogger(JdEmpleadoManager.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
    ...
    public void setTextField() {
        this.txtValor.setText(((this.baseEntity != null) ? this.baseEntity.getStrUsuario() : " "));
        this.txtDescripcion.setText(((this.baseEntity != null) ? this.baseEntity.getStrContraseña() : " "));
    ...
    private void DetectaCambioCombo() {
        if (this.idAccion == 0) {
            ...
            ConfPerfiles x = (ConfPerfiles) cmbEstado.getSelectedItem();
            System.out.println(x.getId() + this.baseEntity.getIdPerfil());
            if (x.getId() != this.baseEntity.getIdPerfil()) {
                this.camCombo = true;
            }
        }
    }
