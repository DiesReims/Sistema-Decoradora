 ...
 * @author Dies
 */
public class IfrmMarca extends javax.swing.JInternalFrame {
...
//</editor-fold>
    ...
    public IfrmMarca() throws SQLException {
        initComponents();
        ...
        String[] head = {"ID", "Estado"};
        String[] headc = {"ID", "Marca"};
        Object[][] cuerpo = {};
        Object[][] cuerpoc = {};
    ...
    public IfrmMarca(Object Permisos) throws SQLException {
...
//</editor-fold>
    ...
    private void setFiltroEstado() throws SQLException {
        ...
        CtrlConfEstadoGlobal estado = new CtrlConfEstadoGlobal();
...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mx/com/diegoA/img/1412742095_marked_price.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mx/com/diegoA/img/1412742095_marked_price.png"))); // NOI18N
        ...
        try {
            ...
            if (objTemp != null) {
                ...
                if (marca.Agregar(objTemp)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Nueva marca registrada con exito");
                } else {
                    //delo contrario = pero indicando
                    JOptionPane.showMessageDialog(null, "No se ha podido registrar la marca");
                }
...
//                }
                ...
                if (objTemp != null) {
                    ...
                    if (marca.Editar(objTemp)) {
                        ...
                        //delo contrario = pero indicando
                        JOptionPane.showMessageDialog(null, "No se ha podido actualizar la marca");
                    }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
            ...
            try {
              JasperReport  reporte = JasperCompileManager.compileReport("ReporteMarcas.jrxml");
