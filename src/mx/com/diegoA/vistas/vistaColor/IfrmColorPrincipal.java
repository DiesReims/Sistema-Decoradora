package mx.com.diegoA.vistas.vistaColor;
...
import mx.com.diegoA.control.control.CtrlConfTipoColor;
import mx.com.diegoA.entidad.entity.ConfColor;
import mx.com.diegoA.entidad.entity.ConfPMA;
import mx.com.diegoA.entidad.entity.ConfTipoColor;
 ...
 * @author Dies
 */
public class IfrmColorPrincipal extends javax.swing.JInternalFrame {

    //<editor-fold defaultstate="collapsed" desc="CuerpoMarca">
    ...
    private ConfColor queryGlobal = new ConfColor();
//</editor-fold>

    //<editor-fold defaultstate="collapsed" desc="Metodos">
    //<editor-fold defaultstate="collapsed" desc="Constructor">
    public IfrmColorPrincipal() throws SQLException {
        initComponents();
        ...
        String[] head = {"ID", "Tipo Material"};
        String[] headc = {"ID", "Material"};
        Object[][] cuerpo = {};
        Object[][] cuerpoc = {};
    ...
    public IfrmColorPrincipal(Object Permisos) throws SQLException {
        initComponents();
    ...
    private void setFiltroEstado() throws SQLException {
        ...
        CtrlConfTipoColor estado = new CtrlConfTipoColor();
        ArrayList<Object> lista = estado.ConsultaCompleja();

        for (int i = 0; i < lista.size(); i++) {
            Object[] filaTemp = new Object[2];
            ConfTipoColor tempObject = (ConfTipoColor) lista.get(i);
...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mx/com/diegoA/img/1412742155_Briefcase.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mx/com/diegoA/img/1412742155_Briefcase.png"))); // NOI18N
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        JdColorManager manager;
        CtrlConfColor marca;
        try {
            marca = new CtrlConfColor();
            manager = new JdColorManager();

            //manager.setVisible(true);
            Object objTemp = manager.showDialog(null);
            ConfColor conf = (ConfColor) objTemp;
            ...
            if (objTemp != null) {
                ...
                if (marca.Agregar(objTemp)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Nuevo color registrado con exito");
                } else {
                    //delo contrario = pero indicando
                    JOptionPane.showMessageDialog(null, "No se ha podido registrar el color");
                }
    ...
    private void jtEstadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtEstadoMouseClicked
        try {
            ...
            Logger.getLogger(IfrmColorPrincipal.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                }
                ...
                if (objTemp != null) {
                    ...
                    if (marca.Editar(objTemp)) {
                        //si el guardado fue correcto manda un mensaje
                        JOptionPane.showMessageDialog(null, "Color actualizado con exito");
                    } else {
                        //delo contrario = pero indicando
                        JOptionPane.showMessageDialog(null, "No se ha podido actualizar el color");
                    }
        ...
        if (tc.getRowCount() > 0) {
            ...
            try {
                ...
                if (marca.Eliminar(Marca)) {
                    //si el guardado fue correcto manda un mensaje
                    JOptionPane.showMessageDialog(null, "Color eliminado con exito");
                } else {
                    //delo contrario = pero indicando
                    JOptionPane.showMessageDialog(null, "No se ha podido eliminar el Color");
                }
                //actualiza los datos del jtable de resultado
                this.Clear_Table();
                this.setcentralgrid();
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        // Imprime el reporte
        try {
            JasperReport reporte = JasperCompileManager.compileReport("ReporteColores.jrxml");
