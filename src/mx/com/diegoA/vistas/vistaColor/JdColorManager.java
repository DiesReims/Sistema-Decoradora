...
import mx.com.diegoA.vistas.vistaMaterial.*;
 ...
 * @author Dies
 */
public class JdColorManager extends javax.swing.JDialog implements IManager {

    //<editor-fold defaultstate="collapsed" desc="Cuerpo Marca Manager">
    //<editor-fold defaultstate="collapsed" desc="Variables">
    private ConfColor baseEntity;
...
//</editor-fold>
     ...
     */
    public JdColorManager(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public JdColorManager() throws SQLException {
        initComponents();
            ...
            if (camCombo == true || camTxt == true || camJTable == true) {
                ...
                if (res == 0) {
                    ...
                    if (this.validaDatos() == true) {
                        ...
                        if (this.idAccion == 0) {
                            this.baseEntity.setIdConfTipoColor(this.cmbEstado.getSelectedIndex());
                        } else {
                            this.baseEntity.setIdConfTipoColor(this.cmbEstado.getSelectedIndex() + 1);
                        }
...
//</editor-fold>
    ...
    public Object showDialog(Object _obj) {
        this.baseEntity = (ConfColor) _obj;
        this.idAccion = (this.baseEntity != null) ? this.baseEntity.getId() : 0;
        if (this.idAccion == 0) {
            this.baseEntity = new ConfColor();
        }
        this.idEstado = this.baseEntity.getIdConfTipoColor();//obtener el id de estado para el combo de editar
        this.setLoadInformation();
    ...
    public boolean setComboBoxInitial() {
        ...
        try {
            CtrlConfTipoColor estadoG = new CtrlConfTipoColor();
    ...
    private void DetectaCambioCombo() {
        if (this.idAccion == 0) {
            ...
            ConfTipoColor x = (ConfTipoColor) cmbEstado.getSelectedItem();
            System.out.println(x.getId() + this.baseEntity.getIdConfTipoColor());
            if (x.getId() != this.baseEntity.getIdConfTipoColor()) {
                this.camCombo = true;
            }
        }
    }
