package mx.com.diegoA.vistas.vistaCliente;
 ...
 * @author Dies
 */
public class IfrmClientePrincipal extends javax.swing.JInternalFrame {
...
//</editor-fold>
    ...
    public IfrmClientePrincipal(Object Permisos) throws SQLException {
        initComponents();
    ...
    public IfrmClientePrincipal() throws SQLException {
        initComponents();
        jtEstado.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
    ...
    private void setFiltroSexo() throws SQLException {
        ...
        CtrlConfSexo sexo = new CtrlConfSexo();
        ConfSexo entitysex = new ConfSexo();
        entitysex.setId(id);
        ...
        {
            ConfSexo tempObject = (ConfSexo) lista.get(i);
...
//        }
    ...
    private void setAditionalTable() throws SQLException {
        ...
        ConfDireccion direcciones = new ConfDireccion();
        ArrayList<Object> lista = ctrldir.ConsultaCompleja(this.idcentral);

        for (int i = 0; i < lista.size(); i++) 
        {
            Object[] filaTemp = new Object[8];
            ConfDireccion tempObject = (ConfDireccion) lista.get(i);
            ...
            filaTemp[0]= tempObject.getId();
            filaTemp[1]= tempObject.getIdConfCliente();
...
//confdireccion.idconfestado= confestados.id and
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            JdClienteManager manager;
            CtrlConfCliente cliente;
            cliente = new CtrlConfCliente();
            manager = new JdClienteManager();

//            manager.setVisible(true); no debe de ponerse
            Object objTemp = manager.showDialog(null);
            ConfCliente conf = (ConfCliente) objTemp;
            ...
            if (objTemp != null) {
                ...
                if (cliente.Agregar(objTemp)) {
                    ...
                    CtrlConfDireccion ctrlDir = new CtrlConfDireccion();
                    CtrlConfCliente ctrlCli = new CtrlConfCliente();
                    this.idultimo = ctrlCli.ConsultarUltimo();

                    for (int i = 0; i < conf.getDireccion().size(); i++) {
                        ConfDireccion direccion;
                        direccion = (ConfDireccion) conf.getDireccion().get(i);
                        System.out.println("datos de dir no." + i + " " + direccion.getStrValor() + " " + direccion.getIdConfCliente() + " " + direccion.getIdConfEstado() + " " + direccion.getIdConfMunicipio());
    ...
    private void jtCentralMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtCentralMouseClicked
        ...
        if (filac != -1) {
            try {
                ...
                CtrlConfSexo sex = new CtrlConfSexo();
                ArrayList<Object> list = sex.ConsultaCompleja(this.idSexo);
                ConfSexo tempObj = (ConfSexo) list.get(0);
...
//                }
                ...
                for (int i = 0; i < lista.size(); i++) {
                    cliente = (ConfCliente) lista.get(i);
                ...
                if (objTemp != null) {
                    ...
                    if (ctrlCliente.Editar(objTemp)) {
                        ...
                        for (int i = 0; i < conf.getDireccion().size(); i++) {
                            ConfDireccion direccion;
                            direccion = (ConfDireccion) conf.getDireccion().get(i);
                            System.out.println("datos de dir no." + i + " " + direccion.getStrValor() + " " + direccion.getIdConfCliente());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (tc.getRowCount() > -1) {
            ...
            PreparedStatement cMarca;
            try {
                cli = new CtrlConfCliente();
                manager = new JdMarcaManager();
                conexion = new ctrlConexion();
                Marca = new ConfCliente();
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        // Imprime el reporte de cliente
          try {
              JasperReport  reporte = JasperCompileManager.compileReport("ReporteCliente.jrxml");
