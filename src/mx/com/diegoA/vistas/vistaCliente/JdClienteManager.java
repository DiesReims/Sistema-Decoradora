...
public class JdClienteManager extends javax.swing.JDialog implements IManager {
    ...
    private ConfCliente baseEntity;
    private CtrlConfDireccion Direccion;
    private ConfDireccion entDir;
     ...
     */
    public JdClienteManager(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public JdClienteManager() throws SQLException {
        initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(2, 2, 2)
                        .addComponent(lblAccion, javax.swing.GroupLayout.PREFERRED_SIZE, 211, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        try {
            ...
            if (this.validaDatos() == true) {
                ...
                if (this.idAccion == 0) {
                    this.baseEntity.setIdConfSexo(this.cbSexo.getSelectedIndex());
                } else {
                    this.baseEntity.setIdConfSexo(this.cbSexo.getSelectedIndex() + 1);
                }
                //Generamos y guardamos el arraylist de direccion y lo mandamos de regreso              
                ArrayList<ConfDireccion> lista = new ArrayList();
                //aqui iba confdir
                for (int i = 0; i < this.jtDireccion.getRowCount(); i++) {
                    this.entDir = new ConfDireccion();
                    entDir.setId((int) this.jtDireccion.getValueAt(i, 0));
                    entDir.setIdConfCliente((int) this.jtDireccion.getValueAt(i, 1));
    ...
    private void btnAgregarDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarDActionPerformed
        ...
        try {
            this.camJTable = true;
            JdDireccionManager manager;
            CtrlConfDireccion ctrlDir;
            ctrlDir = new CtrlConfDireccion();
            manager = new JdDireccionManager();
            Object objTemp = manager.showDialog(null);
            ConfDireccion conf = (ConfDireccion) objTemp;
...
//                System.out.println(""+muni.getNombre()+estado.getNombre());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (this.jtDireccion.getRowCount() > 0) {
            try {
                ...
                ConfDireccion direccion = new ConfDireccion();
                ...
                direccion.setIdConfCliente(this.idCliente);
        ...
        if (this.jtDireccion.getRowCount() > 0) {
            if (this.idDireccion > 0) {
                ...
                if (eliminar == 0) {
                    try {
                         this.camJTable = true;
                        Direccion = new CtrlConfDireccion();
                        ConfDireccion entDir = new ConfDireccion();
    ...
    private void cbSexoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cbSexoMouseClicked
        // combo box mouse clicked
        this.DetectaCambioCombo();
        if (this.idAccion == 0) {
            ...
            ConfSexo x = (ConfSexo) cbSexo.getSelectedItem();
            System.out.println(x.getId() + this.baseEntity.getIdConfSexo());
            if (x.getId() != this.baseEntity.getIdConfSexo()) {
                this.camCombo = true;
            }
        }
    }//GEN-LAST:event_cbSexoMouseClicked

    private void txtnombreMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtnombreMouseClicked
        // evento de mouse click en txtnombre
    ...
    private void txttelefonocasaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txttelefonocasaMouseClicked
        // evento de mouse click en txt tel casa
    ...
    private void txttelefonocelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txttelefonocelMouseClicked
        // evento de mouse click en txt tel celular
...
//</editor-fold>
    ...
    public Object showDialog(Object _obj) {
        this.baseEntity = (ConfCliente) _obj;
        this.idAccion = (this.baseEntity != null) ? this.baseEntity.getId() : 0;
        if (this.idAccion == 0) {
            this.baseEntity = new ConfCliente();
        }
        this.idSexo = this.baseEntity.getIdConfSexo();//obtener el id de estado para el combo de editar
        this.setLoadInformation();
    ...
    public boolean setComboBoxInitial() {
        ...
        try {
            CtrlConfSexo CSexo = new CtrlConfSexo();
            ArrayList<Object> list = CSexo.ConsultaEspecializada(null);
//            consulta = conexion.getCon().prepareStatement("Select * from confsexo");
//            rConsulta = consulta.executeQuery();
            ...
            if (this.idAccion == 0) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ConfSexo SX = (ConfSexo) list.get(i);
                    x.addElement(SX);
                }
