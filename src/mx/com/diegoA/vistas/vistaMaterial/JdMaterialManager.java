 ...
 * @author Dies
 */
public class JdMaterialManager extends javax.swing.JDialog implements IManager {

    //<editor-fold defaultstate="collapsed" desc="Cuerpo Marca Manager">
    //<editor-fold defaultstate="collapsed" desc="Variables">
    private ConfMaterial baseEntity;
...
//</editor-fold>
     ...
     */
    public JdMaterialManager(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public JdMaterialManager() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        picImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mx/com/diegoA/img/1412742155_Briefcase.png"))); // NOI18N
            ...
            if (camCombo == true || camTxt == true || camJTable == true) {
                ...
                if (res == 0) {
                    ...
                    if (this.validaDatos() == true) {
                        ...
                        if (this.idAccion == 0) {
                            this.baseEntity.setIdConfTipoMaterial(this.cmbEstado.getSelectedIndex());
                        } else {
                            this.baseEntity.setIdConfTipoMaterial(this.cmbEstado.getSelectedIndex() + 1);
                        }
...
//</editor-fold>
    ...
    public Object showDialog(Object _obj) {
        this.baseEntity = (ConfMaterial) _obj;
        this.idAccion = (this.baseEntity != null) ? this.baseEntity.getId() : 0;
        if (this.idAccion == 0) {
            this.baseEntity = new ConfMaterial();
        }
        this.idEstado = this.baseEntity.getIdConfTipoMaterial();//obtener el id de estado para el combo de editar
        this.setLoadInformation();
    ...
    public boolean setComboBoxInitial() {
        ...
        try {
            CtrlConfTipoMaterial estadoG = new CtrlConfTipoMaterial();
            ...
            Logger.getLogger(JdMaterialManager.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
    ...
    private void DetectaCambioCombo() {
        if (this.idAccion == 0) {
            ...
            ConfTipoMaterial x = (ConfTipoMaterial) cmbEstado.getSelectedItem();
            System.out.println(x.getId() + this.baseEntity.getIdConfTipoMaterial());
            if (x.getId() != this.baseEntity.getIdConfTipoMaterial()) {
                this.camCombo = true;
            }
        }
    }
