package mx.com.diegoA.vistas.vistaMaterial;
...
import mx.com.diegoA.control.control.CtrlConfTipoMaterial;
import mx.com.diegoA.entidad.entity.ConfMaterial;
import mx.com.diegoA.entidad.entity.ConfPMA;
import mx.com.diegoA.entidad.entity.ConfTipoMaterial;
 ...
 * @author Dies
 */
public class IfrmMaterialPrincipal extends javax.swing.JInternalFrame {

    //<editor-fold defaultstate="collapsed" desc="Cuerpo Material">
    ...
    private ConfMaterial queryGlobal = new ConfMaterial();
//</editor-fold>

    //<editor-fold defaultstate="collapsed" desc="Metodos">
    //<editor-fold defaultstate="collapsed" desc="Constructor">
    public IfrmMaterialPrincipal() throws SQLException {
        initComponents();
    ...
    public IfrmMaterialPrincipal(Object Permisos) throws SQLException {
        initComponents();
    ...
    private void setFiltroEstado() throws SQLException {
        ...
        CtrlConfTipoMaterial estado = new CtrlConfTipoMaterial();
        ArrayList<Object> lista = estado.ConsultaCompleja();

        for (int i = 0; i < lista.size(); i++) {
            Object[] filaTemp = new Object[2];
            ConfTipoMaterial tempObject = (ConfTipoMaterial) lista.get(i);
    ...
    private void setcentralgrid() throws SQLException {
        CtrlConfMaterial marca = new CtrlConfMaterial();
        ArrayList<Object> lista = marca.ConsultaCompleja(this.id);

        for (int i = 0; i < lista.size(); i++) {
            Object[] filaTemp1 = new Object[2];
            ConfMaterial tempObject = (ConfMaterial) lista.get(i);
...
//</editor-fold>
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        JdMaterialManager manager;
        CtrlConfMaterial marca;
        try {
            marca = new CtrlConfMaterial();
            manager = new JdMaterialManager();

            //manager.setVisible(true);
            Object objTemp = manager.showDialog(null);
            ConfMaterial conf = (ConfMaterial) objTemp;
            ...
            if (objTemp != null) {
                ...
                if (marca.Agregar(objTemp)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Nueva material registrado con exito");
                } else {
                    //delo contrario = pero indicando
                    JOptionPane.showMessageDialog(null, "No se ha podido registrar el material");
                }
    ...
    private void jtEstadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtEstadoMouseClicked
        try {
            ...
            Logger.getLogger(IfrmMaterialPrincipal.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                }
                ...
                for (int i = 0; i < lista.size(); i++) {
                    Marca = (ConfMaterial) lista.get(i);
                ...
                if (objTemp != null) {
                    ...
                    if (marca.Editar(objTemp)) {
                        ...
                        //delo contrario = pero indicando
                        JOptionPane.showMessageDialog(null, "No se ha podido actualizar el material");
                    }
        ...
        if (tc.getRowCount() > 0) {
            ...
            try {
                ...
                if (marca.Eliminar(Marca)) {
                    ...
                    //delo contrario = pero indicando
                    JOptionPane.showMessageDialog(null, "No se ha podido eliminar el Material");
                }
                //actualiza los datos del jtable de resultado
                this.Clear_Table();
                this.setcentralgrid();
    ...
    private void btnBuscarEspecialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarEspecialActionPerformed
        ...
        try {
            CtrlConfMaterial cMarca = new CtrlConfMaterial();
            this.consultaE = this.txtBuscar.getText();
            this.queryGlobal.setStrBusqueda(this.consultaE);
            this.queryGlobal.setIdConfTipoMaterial(id);
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        try {
            JasperReport reporte = JasperCompileManager.compileReport("ReporteMaterial.jrxml");
