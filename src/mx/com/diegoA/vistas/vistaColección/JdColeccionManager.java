...
public class JdColeccionManager extends javax.swing.JDialog implements IManager {

    //<editor-fold defaultstate="collapsed" desc="Cuerpo Coleccion Manager">
    //<editor-fold defaultstate="collapsed" desc="Variables">
    private ConfColeccion baseEntity;
...
//</editor-fold>
     ...
     */
    public JdColeccionManager(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public JdColeccionManager() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        picImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mx/com/diegoA/img/1412742122_Catalog.png"))); // NOI18N
...
//</editor-fold>
    ...
    public Object showDialog(Object _obj) {
        this.baseEntity = (ConfColeccion) _obj;
        this.idAccion = (this.baseEntity != null) ? this.baseEntity.getId() : 0;
        if (this.idAccion == 0) {
            this.baseEntity = new ConfColeccion();
        }
    ...
    public void setComboBox() {
        ...
        if (this.idAccion > 0) {
            //this.cmbEstado.setSelectedIndex(this.idEstado);
            for (int i = 0; i < this.cmbEstado.getItemCount(); i++) {
                ConfMarca objTemp = (ConfMarca) this.cmbEstado.getItemAt(i);
