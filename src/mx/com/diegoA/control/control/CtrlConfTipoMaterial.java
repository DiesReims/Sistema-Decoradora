 ...
 * @author Dies
 */
public class CtrlConfTipoMaterial extends ctrlConexion implements IAccionesDB {

    ctrlConexion ctrlConexion;

    public CtrlConfTipoMaterial() throws SQLException {
    ...
    public ArrayList<Object> ConsultaCompleja() {
        ArrayList<ConfTipoMaterial> consulta = new ArrayList();
        PreparedStatement consultaCompleja;
        ResultSet resultado;

        try {
            consultaCompleja = ctrlConexion.getCon().prepareStatement("Select * from ConfTipoMaterial");
            ...
            while (resultado.next()) {//System.out.println(resultado.getString(1)+" "+resultado.getString(2)+" "+resultado.getString(3));
                ConfTipoMaterial temp = new ConfTipoMaterial();
            ...
            Logger.getLogger(CtrlConfTipoMaterial.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
