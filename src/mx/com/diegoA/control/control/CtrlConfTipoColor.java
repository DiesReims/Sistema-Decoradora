 ...
 * @author Dies
 */
public class CtrlConfTipoColor extends ctrlConexion implements IAccionesDB {

    ctrlConexion ctrlConexion;

    public CtrlConfTipoColor() throws SQLException {
    ...
    public ArrayList<Object> ConsultaCompleja() {
        ArrayList<ConfTipoColor> consulta = new ArrayList();
        PreparedStatement consultaCompleja;
        ResultSet resultado;

        try {
            consultaCompleja = ctrlConexion.getCon().prepareStatement("Select * from ConfTipoColor");
            ...
            while (resultado.next()) {//System.out.println(resultado.getString(1)+" "+resultado.getString(2)+" "+resultado.getString(3));
                ConfTipoColor temp = new ConfTipoColor();
            ...
            Logger.getLogger(CtrlConfTipoColor.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
