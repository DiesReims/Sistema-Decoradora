 ...
 * @author Dies
 */
public class CtrlVenEstadoVenta extends ctrlConexion implements IAccionesDB {

    ctrlConexion ctrlConexion;

    public CtrlVenEstadoVenta() throws SQLException {
    ...
    public ArrayList<Object> ConsultaCompleja() {
        ArrayList<VenEstadoVenta> consulta = new ArrayList();
        PreparedStatement consultaCompleja;
        ResultSet resultado;

        try {
            consultaCompleja = ctrlConexion.getCon().prepareStatement("Select * from venEstadoVenta");
            ...
            while (resultado.next()) {//System.out.println(resultado.getString(1)+" "+resultado.getString(2)+" "+resultado.getString(3));
                VenEstadoVenta temp = new VenEstadoVenta();
            ...
            Logger.getLogger(CtrlVenEstadoVenta.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
